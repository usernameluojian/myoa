			...
			$(function () {
				$("tbody tr td a").click(function(){
					if (typeof($(this).attr("date-oneid")) != "undefined") { 
						$.ajax({
							url:"${pageContext.request.contextPath}/MessageSendingBoxOne",
							data:{id:$(this).attr("date-oneid")},
							type:"get",
							dataType:"json",
							success:function(json){
								...
								$("#editPanel #Reply").attr("style","display:none;");
							}
						});
    		...
    		<div style="width: 100%;height: 20px;">
	            ...
	            <table class="table">
	              ...
	              <c:forEach var="m" items="${ListMessage }">
	                  ...
	                  <td>${m.sendtime }</td>
	                  <td>
	                  	<a class="btn" date-oneid="${m.id }"><i class="icon-search"></i></a>
	            ...
	            <div style="width: 100%;text-align: center;">
    				<div class="pagination">
					  <ul>
						<c:if test="${page!=1 }">
					    	<li><a href="messagesendingbox?page=${page-1}">上一页</a></li>
					    </c:if>
					    <c:forEach var="i" begin="1" end="${pagecount }">
						    <li><a href="messagesendingbox?page=${i }">${i }</a></li>
					    </c:forEach>
					    <c:if test="${page+1<=pagecount}">
					    	<li><a href="messagesendingbox?page=${page+1}">下一页</a></li>
					    </c:if>
					  </ul>
					</div>
    			</div>
